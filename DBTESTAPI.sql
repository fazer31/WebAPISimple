use master
go
IF NOT EXISTS(SELECT name FROM master.dbo.sysdatabases WHERE NAME = 'DBTESTAPI')
CREATE DATABASE DBTESTAPI
...
INSERT [dbo].[USUARIO] ([DocumentoIdentidad], [Nombres], [Telefono], [Correo], [Ciudad]) VALUES ( N'77707770', N'Fernando', N'8672124515', N'fserrano3101@gmail.com', N'Nuevo Laredo')
